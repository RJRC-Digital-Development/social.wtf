...
function calculateFeeSplit(totalCook, feeBpsNum = 5) {
  if (totalCook <= 0) {
...
{
  const result = calculateFeeSplit(0.000000001, 5);
...
{
  const result = calculateFeeSplit(0.000000019, 5);
...
{
  const result = calculateFeeSplit(0.0000001, 5);
  assert.strictEqual(result.totalLamports, 100n);
  assert.strictEqual(result.treasuryLamports, 0n);
  assert.strictEqual(result.creatorLamports, 100n);
  assert.strictEqual(result.creatorLamports + result.treasuryLamports, result.totalLamports);
...
{
  const result = calculateFeeSplit(1_000_000, 5);
  assert.strictEqual(result.totalLamports, 1_000_000_000_000_000n);
  assert.strictEqual(result.treasuryLamports, 500_000_000_000n);
  assert.strictEqual(result.creatorLamports, 999_500_000_000_000n);
  assert.strictEqual(result.creatorLamports + result.treasuryLamports, result.totalLamports);
