...
1. **Push Code to GitHub**:
   ...
   git remote add origin https://github.com/RJRC-Digital-Development/social.wtf.git
...
3. **Live URL**:
   Your live application will be instantly available at `https://socialwtf.vercel.app` (or your custom domain).
